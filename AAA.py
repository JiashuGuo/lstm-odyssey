...
# load dataset
train_data, valid_data, test_data, _ = ptb_reader.ptb_raw_data("/Users/jiashu/Documents/LAB/LSTM/lstm-odyssey-master/simple-examples/data")
...
with tf.Graph().as_default(), tf.Session() as sess:
    ...
    for i in range(num_epochs):
        ...
        saver.save(sess, checkpoint_path + 'gdl')
